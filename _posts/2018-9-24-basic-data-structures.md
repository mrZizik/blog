...
Дополнительно в некоторых реализациях у стека имеются методы вывода размера, печати всего стека или чтения элемента с вершины стека оставляя сам стек неизменным.
...
{([
```
Позже найдя закрывающую квадратную скобку, IDE сравнивает ее с элементом на вершине стека и т.к. скобки парные, удаляет ее. Тоже самое происходит и с круглой скобкой. Так же на стек добавляется фигурная скобка начала метода main.

```
{ {
```
Дальше IDE находит две закрывающие фигурные скобки и пошагово вызывает метод pop на стеке. К концу кода стек оказывается пустым и IDE понимает, что все со скобками хорошо. 

стек можно имплементировать поверх связного списка или динамического массива. В обоих случаях и положить элемент на стек и снять с него можно за константное время O(1). В случае с массивом, для ускорения нам надо будет допустить, что основание стека будет началом массива и вершиной стека конец. В таком случае добавление и удаление элементов в конец массива будет быстрее, т.к. нам не надо будет каждый раз сдвигать весь массив.
